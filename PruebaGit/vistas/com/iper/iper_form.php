            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form  id="frmIper" method="post" class="form" enctype="multipart/form-data;charset=UTF-8">
                        <div class="row">
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <input type="text" id="txtCodigoIper" name="txtCodigoIper" class="form-control" value="">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <button type="button" name="btnAgregar" id="btnAgregar" onclick="agregarGridIper();" class="btn btn-info w-sm m-b-5" style="border-radius: 0px;"><i class="fa fa-plus-square-o"></i> Agregar</button>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
