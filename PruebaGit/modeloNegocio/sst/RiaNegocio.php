...
class RiaNegocio extends ModeloNegocioBase {
    ...
    public function crearRiaRie($eveFecha, $eveHora, $sucCodLegado, $sucDescripcion, $gerCodLegado,
            ...
            $descripcion, $respuesta, $comentario, $usuCreacion) {
        $estado = ConstantesNegocio::PARAM_ACTIVO;
...
//                    foreach ($testigos as $tes) {
//                        $testId = UsuarioNegocio::create()->obtenerUsuarioId($tes['usuCodAd']);
//                        $r = $this->insertarRiaRieTestigo($riaRie[0]['id'], $testId, $estado, $usuCreacion);
//                    }
                }
                return $riaRie;
            }
